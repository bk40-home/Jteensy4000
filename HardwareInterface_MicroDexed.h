...
private:
    ...
    static constexpr uint8_t ENC_L_A_PIN  = 32;   // Phase A (interrupt-capable)
    static constexpr uint8_t ENC_L_B_PIN  = 31;   // Phase B (interrupt-capable)
    static constexpr uint8_t ENC_L_SW_PIN = 30;   // Button/switch

    // Right encoder (ENC_R): Value adjust, confirm, select
    static constexpr uint8_t ENC_R_A_PIN  = 28;   // Phase A (interrupt-capable)
    static constexpr uint8_t ENC_R_B_PIN  = 29;   // Phase B (interrupt-capable)
    static constexpr uint8_t ENC_R_SW_PIN = 25;   // Button/switch
